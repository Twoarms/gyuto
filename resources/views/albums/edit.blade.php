...
@section('script')
    ...
    <script>
		...
		// var btnConf = document.getElementById("conf");
		...
		function getFocus(bout) {
			...
			// console.log(filenameSrc + ' ' + filename);

		}

		// function getFocusImg() {
		// 	let varSaveImg = document.getElementById("saveImg");
		// 	document.getElementById("titleFr").focus();			
		// 	// document.getElementById("preview").src = varMyImg.src;
		// 	// document.getElementById("gyuto").setAttribute("value", filename);
		// 	// console.log(filenameSrc + ' ' + filename);
