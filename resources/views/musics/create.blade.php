...
@section('content')
	{!! Form::open(['action' => 'MusicsController@store', 'method' => 'POST', 'files' => true]) !!}
	<h2>CONCERT</h2>
	...
	<div class="form-group font-weight-bold">
		...
		{{Form::text('legendMFr', '', ['class' => 'form-control', 'placeholder' => 'Légende de votre Vidéo Musique en Français']) }}
	</div>	
	<div class="form-group font-weight-bold">
		{{Form::label('legendMEn', 'Légende EN')}}
		{{Form::text('legendMEn', '', ['class' => 'form-control', 'placeholder' => 'Légende de votre Vidéo Musique en Anglais']) }}
	</div>
	<h2>INFORMATIONS</h2>
	<div class="form-group font-weight-bold">
		{{Form::label('titleMFr', 'Titre FR')}}
		{{Form::text('titleMFr', '', ['class' => 'form-control', 'placeholder' => 'Titre de votre Texte Musique en Français']) }}
	</div>	
	<div class="form-group font-weight-bold">
		{{Form::label('titleMEn', 'Titre EN')}}
		{{Form::text('titleMEn', '', ['class' => 'form-control', 'placeholder' => 'Titre de votre Texte Musique en Anglais']) }}
	</div>

	<div class="form-group font-weight-bold">
		{{Form::label('textMFr', 'Texte FR')}}
		{{Form::textarea('textMFr', '', ['class' => 'form-control', 'placeholder' => 'Votre Texte Musique en Français']) }}
	</div>	
	<div class="form-group font-weight-bold">
		{{Form::label('textMEn', 'Texte EN')}}
		{{Form::textarea('textMEn', '', ['class' => 'form-control', 'placeholder' => 'Votre Texte Musique en Anglais']) }}
	</div>
	<h2>ALBUMS</h2>	
	<div class="form-group font-weight-bold">
		{{Form::label('titleAlbum', 'Titre Album FR')}}
		{{Form::text('titleAlbum', '', ['class' => 'form-control', 'placeholder' => 'Titre de votre Album Musique en Français']) }}
	</div>	
	<div class="form-group font-weight-bold">
		{{Form::label('urlAlbumMusicCdeFr', 'URL Album Music Commander Fr')}}
		{{Form::text('urlAlbumMusicCdeFr', '', ['class' => 'form-control', 'placeholder' => 'URL de votre Album Music à commander Fr']) }}
	</div>
	<div class="form-group font-weight-bold">
		{{Form::label('urlAlbumMusicCdeEn', 'URL Album Music Commander En')}}
		{{Form::text('urlAlbumMusicCdeEn', '', ['class' => 'form-control', 'placeholder' => 'URL de votre Album Music à commander En']) }}
	</div>
	<div class="form-group font-weight-bold">
...
<div class="card">
				<div class="card-header font-weight-bold" id="myBtnG">Galerie de Musiques
				</div>
				<div class="card-body">	
			  		<br>
