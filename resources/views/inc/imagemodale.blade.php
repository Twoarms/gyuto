<h3 class="card-header">Détail de l'image</h3>		
	<div class="card-body">
		...
		<div class="form-group font-weight-bold">
			...
			{{Form::text('titleIEn', '', ['class' => 'form-control', 'placeholder' => 'Titre EN']) }}
		</div>
		<div class="form-group font-weight-bold">
			{{Form::label('legendIFr', 'Légende FR')}}
			{{Form::text('legendIFr', '', ['class' => 'form-control', 'placeholder' => 'Légende FR']) }}
		</div>
		<div class="form-group font-weight-bold">
			{{Form::label('legendIEn', 'Légende EN')}}
			{{Form::text('legendIEn', '', ['class' => 'form-control', 'placeholder' => 'Légende EN']) }}
		</div>
