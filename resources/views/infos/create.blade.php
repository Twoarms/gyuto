...
@section('content')
	<div class="container-fluid">
		...
		<input id="prodId" name="parent_id" type="text" value="{{$infoparentid}}">
		@else
		<input id="prodId" name="parent_id" type="text" value="0">
		@endif
...
<!--   									<div class="row">
	  									<div class="card col-sm-7"> -->
	  										<div class="card-body">
												<div class="form-group font-weight-bold">
													{{Form::label('textParFr', 'Texte FR')}}
													{{Form::textarea('textParFr', '', ['class' => 'form-control', 'placeholder' => 'Texte FR']) }}
												</div>
												<div class="form-group font-weight-bold">
													{{Form::label('textParEn', 'Texte EN')}}
													{{Form::textarea('textParEn', '', ['class' => 'form-control', 'placeholder' => 'Texte EN']) }}
												</div>	
										</div>		
						  			<div class="card col-sm-5" id="smyBtnS">
										@include('inc.imagemodale', ['imageid' => $theimage->id])
