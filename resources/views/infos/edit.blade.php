...
@section('content')
	<div class="container-fluid">
		<div class="card-body">
			...
			<input id="prodId" name="parent_id" type="text" value="{{$info->parent_id}}">
			...
			<div class="form-group font-weight-bold">
				...
				{{Form::textarea('textInFr', $info->textInFr, ['class' => 'form-control', 'placeholder' => 'Texte FR']) }}
			</div>
			<div class="form-group font-weight-bold">
				{{Form::label('textInEn', 'Texte EN')}}
				{{Form::textarea('textInEn', $info->textInEn, ['class' => 'form-control', 'placeholder' => 'Texte EN']) }}
			</div>	
			<div class="card">
				<div class="card-header font-weight-bold" id="myBtnG">Galerie d'images
				</div>
				<div class="card-body">
					@if ($info->imagepages()->count() > 0)	
						@foreach($info->imagepages as $theimage)
