	...
	<div class="container">
			...
			<div class="card">
					...
					@if ($paragraph->imagepages()->count() > 0)	
			  		...
			  		<br>
			  		<div class="btn-group">
					<a href="#"><button type="button" class="btn btn-outline-primary form-control" id="">Ajouter à la galerie</button></a>
					<a href="#"><button type="button" class="btn btn-outline-primary form-control" id="">Mise à jour Galerie</button></a>
					</div>
			</div>
			<br>
...
@section('script')
    ...
    <script>
		...
		function charger(bout) {
			console.log(bout);
			// document.getElementById("myModalEditPar").id = "myModalEditPar" + para;
			// console.log("myModalEditPar" + para);
			// let idtheModalEditPar = "myModalEditPar" + para;
			// console.log(theModalEditPar);
			// theModalEditPar.id = idtheModalEditPar;
			...
			// let myma = document.getElementById("ma");
			...
			// // console.log(bout);
			// console.log(myma);
			// document.getElementById("myparagId").setAttribute("value", myidparagText);
			// document.getElementById("mythetitleParFr").setAttribute("value", myidtitleParFrText);
			// document.getElementById("mythetitleParEn").setAttribute("value", myidtitleParEnText);
			// document.getElementById("mythetextParFr").setAttribute("value", myidtextParFrText);
			// document.getElementById("mythetextParEn").setAttribute("value", myidtextParEnText);
			...
			console.log(myidtextParEn.innerText);
			console.log(mythetitleParEn.value);			
		}
