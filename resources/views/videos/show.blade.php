      ...
      <div class="container-fluid">
        <div class="card col-sm-5">
          ...
          <div class="card-body">
            ...
            <br>
            @if ($video->imagepage) 
              <a href="#" class="btn btn-primary" id="myBtn">Voir la galerie</a>              
            @endif
          </div>
        </div>
        <div class="card col-sm-5 imageCover">
          ...
          <div class="card-body imageCover">  
            @if ($video->imagepage->cover == '1') 
              <img src="{{ url('myimages/' . $theimage->nameImage) }}" class="img-thumbnail" id="myBtn{{$theimage->id}}">
              <a href="#" class="btn btn-primary" id="myBtn">Voir la Mise en avant</a>
              <br>
            @endif    
          </div>        
        </div>
...
<!--   </div> -->
  ...
  <div class="form-group font-weight-bold">
    <button type="submit" id="" name="confirmer" value="confirmer">Fermer</button>
<!--     {!! Form::close() !!} -->
  </div>
  </div>  
@endsection
